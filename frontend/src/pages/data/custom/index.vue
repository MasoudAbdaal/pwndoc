        ...
        <q-tab-panels v-model="selectedTab" class="bg-transparent col-md-10 col-12 offset-md-1 q-mt-md" @before-transition="Utils.syncEditors($refs)">
            ...
            <q-tab-panel name="languages">
                <q-card>
                    ...
                    <q-card-section class="row">
                        <div class="col-md-6 col-12" v-if="userStore.isAllowed('languages:create')">
                            <q-item>
                                <q-item-section>
                                    <q-input
                        ...
                        <div v-if="!editLanguage" class="col-md-6 col-12">
                            <q-card flat bordered v-if="languages.length > 0">
                                <q-toolbar>
                                    ...
                                    <q-space />
                                    <q-btn v-if="userStore.isAllowed('languages:update')" flat color="primary" icon="fa fa-edit" @click="editLanguage = true; editLanguages = $_.cloneDeep(languages)">
                        ...
                        <div v-else class="col-md-6 col-12">
                            ...
                            <q-separator />
                            <q-card-section>
                                    <draggable v-model="editLanguages" item-key="locale" handle=".handle" ghost-class="drag-ghost">
                ...
                <q-card>
                    ...
                    <q-card-section v-if="languages.length > 0" class="row">
                        ...
                        <div v-if="!editAuditType" class="col-md-6 col-12">
                            <q-card flat bordered v-if="auditTypes.length > 0">
                                <q-toolbar>
                                    ...
                                    <q-space />
                                    <q-btn v-if="userStore.isAllowed('audit-types:update')" flat color="primary" icon="fa fa-edit" @click="editAuditType = true; editAuditTypes = $_.cloneDeep(auditTypes)">
                                        <q-tooltip anchor="bottom middle" self="center left" :delay="500" class="text-bold">{{$t('tooltip.edit')}}</q-tooltip> 
                                    </q-btn>
                                </q-toolbar>
                                <q-separator />
                        ...
                        <div v-else class="col-md-6 col-12">
                            ...
                            <q-separator />
                            <q-card-section>
                                    <draggable v-model="editAuditTypes" item-key="_id" handle=".handle" ghost-class="drag-ghost">
                                        <template #item="{element: auditType}">
                                            <q-item>
                                                <q-item-section avatar>
                                                    <q-icon name="mdi-arrow-split-horizontal" class="cursor-pointer handle" color="grey" />
                                                </q-item-section>
                                                        ...
                                                        <q-item>
                                                            <q-item-section>
                                                                <div v-for="(language,idx) of languages">
                                                                    ...
                                                                    <!-- needed for updating old Audit Types without templates -->
                                                                    <q-select 
                                                                    v-else
            ...
            <q-tab-panel name="vulnerability-types">
                <q-card>
                    ...
                    <q-card-section v-if="languages.length > 0" class="row">
                        <div class="col-md-6 col-12" v-if="userStore.isAllowed('vulnerability-types:create')">
                            <q-item class="row">
                        ...
                        <div v-if="!editVulnType" class="col-md-6 col-12">
                            <q-card flat bordered v-if="vulnTypes.length > 0">
                                <q-toolbar>
                                    ...
                                    <q-space />
                                    <q-btn v-if="userStore.isAllowed('vulnerability-types:update')" flat color="primary" icon="fa fa-edit" @click="editVulnType = true; editVulnTypes = $_.cloneDeep(vulnTypes)">
                                        <q-tooltip anchor="bottom middle" self="center left" :delay="500" class="text-bold">{{$t('tooltip.edit')}}</q-tooltip> 
                                    </q-btn>
                            </q-toolbar>
                            <q-separator />
                                <q-item v-for="vulnType of vulnTypesLocale" :key="vulnType.name">
                                    <q-item-section>
                                        <q-input
                                        :label="$t('name')"
                        ...
                        <div v-else class="col-md-6 col-12">
                            ...
                            <q-separator />
                            <q-card-section>
                                    <draggable v-model="editVulnTypes" item-key="_id" handle=".handle" ghost-class="drag-ghost">
                                        <template #item="{element: vulnType}">
                                            <q-item v-if="vulnType.locale === newVulnType.locale">
                                                <q-item-section avatar>
                                                    <q-icon name="mdi-arrow-split-horizontal" class="cursor-pointer handle" color="grey" />
                                                </q-item-section>
                                                <q-item-section>
            ...
            <q-tab-panel name="vulnerability-categories">
                <q-card>
                    ...
                    <q-card-section class="row">
                        <div class="col-md-6 col-12" v-if="userStore.isAllowed('vulnerability-categories:create')">
                            <q-item>
                                <q-item-section>
                                    <q-input
                        ...
                        <div v-if="!editCategory" class="col-md-6 col-12">
                            <q-card flat bordered v-if="vulnCategories.length > 0">
                                <q-toolbar>
                                    ...
                                    <q-space />
                                    <q-btn v-if="userStore.isAllowed('vulnerability-categories:update')" flat color="primary" icon="fa fa-edit" @click="editCategory = true; editCategories = $_.cloneDeep(vulnCategories)">
                                        <q-tooltip anchor="bottom middle" self="center left" :delay="500" class="text-bold">{{$t('tooltip.edit')}}</q-tooltip> 
                                    </q-btn>
                                </q-toolbar>
                                <q-separator />
                        ...
                        <div v-else class="col-md-6 col-12">
                            ...
                            <q-separator />
                            <q-card-section>
                                    <draggable v-model="editCategories" item-key="_id" handle=".handle" ghost-class="drag-ghost">
                                        <template #item="{element: vulnCat}">
                                            <q-item>
                                                <q-item-section avatar>
                                                    <q-icon name="mdi-arrow-split-horizontal" class="cursor-pointer handle" color="grey" />
                                                </q-item-section>
            ...
            <q-tab-panel name="custom-fields">
                <q-card>
                        ...
                        <q-item v-if="userStore.isAllowed('custom-fields:create')" class="q-pl-none">
                            ...
                            <q-item-section class="col-md-4" top>
                                ...
                                <q-item>
                                    ...
                                    <q-item-section v-if="['radio', 'checkbox'].includes(newCustomField.fieldType)">
                                        <q-toggle
                                        :label="$t('horizontal')"
                                        v-model="newCustomField.inline"
                                        />
                                    </q-item-section>
                                </q-item>
                            </q-item-section>
                    ...
                    <q-card-section v-if="userStore.isAllowed('custom-fields:create')">
                ...
                <q-card class="q-mt-md" v-if="canDisplayCustomFields()">
                    ...
                    <q-separator />
                    <q-card-section>
                        <draggable v-model="customFields" item-key="_id" group="cfields" handle=".handle" ghost-class="drag-ghost" direction="horizontal" class="row">
                                        ...
                                        <q-btn flat color="primary" icon="mdi-pencil" :data-testid="`edit-custom-field-${field.label}`" dense size="sm">
                                            <q-menu style="width: 300px" anchor="top left" self="top end">
                                                ...
                                                <q-item v-if="field.fieldType !== 'space'">
                                                    ...
                                                    <q-item-section v-if="['radio', 'checkbox'].includes(field.fieldType)">
                                                        <q-toggle
                                                        :label="$t('horizontal')"
                                    ...
                                    <q-item-section>
                                        ...
                                        >
                                            <template v-slot:append>
                                                ...
                                                <q-popup-proxy ref="qDateProxy" transition-show="scale" transition-hide="scale">
                                                    <q-date first-day-of-week="1" mask="YYYY-MM-DD" v-model="field.text[getFieldLocaleText(index)].value" @update:model-value="$refs.qDateProxy.forEach(e => e.hide())" />
                                                </q-popup-proxy>
                                                </q-icon>
                                            </template>
                                            <template v-slot:label>
                                        ...
                                        >
                                            <template v-slot:control>
                                                ...
                                                />
                                                <q-space />
                                                <q-btn flat label="clear" @click="field.text[getFieldLocaleText(index)].value = ''" />
                                            </template>
                                            <template v-slot:label>
                                                {{field.label}} <span v-if="field.required" class="text-red">*</span>
                                            </template>
                    ...
                    <q-card-section v-if="userStore.isAllowed('custom-fields:update')">
            ...
            <q-tab-panel name="custom-sections">
                <q-card>
                    ...
                    <q-card-section v-if="languages.length > 0" class="row">
                        <div class="col-md-6 col-12" v-if="userStore.isAllowed('sections:create')">
                            <q-item>
                                <q-item-section>
                                    <q-input
                        ...
                        <div v-if="!editSection" class="col-md-6">
                            <q-card flat bordered v-if="sections.length > 0">
                                <q-toolbar>
                                    ...
                                    <q-space />
                                    <q-btn v-if="userStore.isAllowed('sections:update')" flat color="primary" icon="fa fa-edit" @click="editSection = true; editSections = $_.cloneDeep(sections)">
                        ...
                        <div v-else class="col-md-6">
                            <q-card flat bordered>
                                ...
                                <q-separator />
                                <q-card-section>
                                    <draggable v-model="editSections" item-key="_id" handle=".handle" ghost-class="drag-ghost" direction="horizontal">
