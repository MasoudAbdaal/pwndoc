export default {
    ...
    search: 'Suche',
    searchUsersPlaceholder: 'Benutzer nach Name, E-Mail oder Benutzername suchen...',
    any: 'Alle',
    all: 'Alle',
    status: 'Status',
    actions: 'Aktionen',
    ...
    forThisUser: 'für diesen Benutzer',
    disableUsersWarning: 'Deaktivierte Benutzer können sich nicht anmelden oder auf das System zugreifen. Sie können jederzeit wieder aktiviert werden.',
    auditNum1: 'Audit',
    auditNums: 'Audits',
    ...
    draftRecovery: {
        title: 'Wiederhergestellte Änderungen',
        message: 'Überprüfen Sie die Unterschiede zwischen Ihren wiederhergestellten Änderungen und der zuletzt gespeicherten Version.',
        savedAt: 'Lokal gespeichert am',
        currentVersion: 'Zuletzt gespeicherte Version',
        draftVersion: 'Ihre wiederhergestellten Änderungen',
        noDifferences: 'Keine Unterschiede gefunden',
        unifiedView: 'Einheitlich',
        splitView: 'Geteilt',
        localDraftLabel: 'Wiederhergestellte Änderungen',
        serverVersionLabel: 'Serverversion',
        localDraftExists: 'Wiederhergestellte Änderungen vorhanden',
        viewingLocalDraft: 'Sie sehen Ihre wiederhergestellten Änderungen',
        notSavedToServer: 'Speichern Sie, um Ihre Änderungen zu behalten',
        viewingServerVersion: 'Sie sehen die zuletzt gespeicherte Version',
        localDraftNotApplied: 'Wiederhergestellte Änderungen vorhanden, aber nicht angewendet',
        draftExpiresIn: 'Läuft ab in',
        draftExpired: 'Abgelaufen',
        clearedAfterInactivity: 'Bis dahin wiederherstellbar',
        discardDraft: 'Zur gespeicherten Version zurückkehren',
        discardLocalChanges: 'Zur zuletzt gespeicherten Version zurückkehren',
        viewChangesLabel: 'Änderungen anzeigen',
        reviewChangesInDraft: 'Änderungen in diesem Entwurf überprüfen',
        restoreDraftLabel: 'Wiederhergestellte Änderungen anwenden',
        replaceWithDraft: 'Aktuellen Inhalt durch wiederhergestellte Änderungen ersetzen',
        deletePermanently: 'Wiederhergestellte Änderungen dauerhaft löschen',
        actionCannotBeUndone: 'Diese Aktion kann nicht rückgängig gemacht werden',
        compareWithDraft: 'Gespeicherte Version mit wiederhergestellten Änderungen vergleichen',
        saveHint: 'Verwenden Sie Speichern (Strg+S) in der Symbolleiste, um Ihre Änderungen zu speichern.',
        edited: 'Bearbeitet',
        editedJustNow: 'Gerade bearbeitet'
    },
    roles: 'Roles',
    rolesPageSubtitle: 'Verwalten Sie Rollen und ihre Berechtigungen. Rollen definieren, worauf Benutzer zugreifen können.',
    createRole: 'Create Role',
    editRole: 'Edit Role',
    viewRole: 'View Role',
    deleteRole: 'Delete Role',
    searchRolesPlaceholder: 'Rollen suchen...',
    allTypes: 'Alle Typen',
    customRole: 'Benutzerdefiniert',
    adminRoleDescription: 'Vollständiger Plattformzugriff. Verwaltung aller Einstellungen, Benutzer und Daten.',
    userRoleDescription: 'Basiszugriff zum Anzeigen zugewiesener Daten.',
    roleDescriptionFallback: 'Keine Beschreibung vorhanden.',
