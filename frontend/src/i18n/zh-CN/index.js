export default {
    ...
    newAudit: '新的审计',
    search: '搜索',
    searchUsersPlaceholder: '按姓名、邮箱或用户名搜索用户...',
    any: '任意',
    all: '全部',
    status: '状态',
    actions: '操作',
    ...
    forThisUser: '此用户',
    disableUsersWarning: '禁用的用户将无法登录或访问系统。你可以随时重新启用他们。',
    auditNum1: '个审计项目',
    auditNums: '个审计项目',
    ...
    draftRecovery: {
        title: '已恢复的更改',
        message: '查看您已恢复的更改与最后保存版本之间的差异。',
        savedAt: '本地保存于',
        currentVersion: '最后保存的版本',
        draftVersion: '您已恢复的更改',
        noDifferences: '未发现差异',
        unifiedView: '统一视图',
        splitView: '分屏视图',
        localDraftLabel: '已恢复的更改',
        serverVersionLabel: '服务器版本',
        localDraftExists: '存在已恢复的更改',
        viewingLocalDraft: '您正在查看已恢复的更改',
        notSavedToServer: '保存以保留您的更改',
        viewingServerVersion: '您正在查看最后保存的版本',
        localDraftNotApplied: '存在已恢复的更改但未应用',
        draftExpiresIn: '将在以下时间后过期：',
        draftExpired: '已过期',
        clearedAfterInactivity: '在此之前可恢复',
        discardDraft: '恢复到已保存版本',
        discardLocalChanges: '返回到最后保存的版本',
        viewChangesLabel: '查看更改',
        reviewChangesInDraft: '查看此草稿中的更改',
        restoreDraftLabel: '应用已恢复的更改',
        replaceWithDraft: '用已恢复的更改替换当前内容',
        deletePermanently: '永久删除已恢复的更改',
        actionCannotBeUndone: '此操作无法撤销',
        compareWithDraft: '将已保存版本与已恢复的更改对比',
        saveHint: '使用工具栏中的保存（Ctrl+S）来保存您的更改。',
        edited: '已编辑',
        editedJustNow: '刚刚编辑'
    },
    roles: 'Roles',
    rolesPageSubtitle: '管理角色及其权限。角色定义用户可以访问和执行的操作。',
    ...
    allTypes: '所有类型',
    customRole: '自定义',
    adminRoleDescription: '完整平台访问权限。管理所有设置、用户和数据。',
    userRoleDescription: '查看已分配数据的基础访问权限。',
    roleDescriptionFallback: '未提供描述。',
    allPermissions: '所有权限',
