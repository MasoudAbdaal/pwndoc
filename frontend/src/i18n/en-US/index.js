export default {
    ...
    msg: {
        ...
        errorDeleting: 'Error deleting rule',
        ...
        languageToolConnectionFailed: 'Failed to test LanguageTool connection',
        ltConnectionFailed: 'LanguageTool URL is unreachable — fix it before saving',
        ltNotLanguageTool: 'URL is reachable but not a LanguageTool endpoint — fix it before saving',
        ltAuthFailed: 'LanguageTool credentials are invalid — fix them before saving',
    ...
    roles: 'Roles',
    rolesPageSubtitle: 'Manage roles and their permissions. Roles define what users can access and do.',
    ...
    allTypes: 'All Types',
    customRole: 'Custom',
    adminRoleDescription: 'Full platform access. Manage all settings, users, and data.',
    userRoleDescription: 'Basic access to view assigned data.',
    roleDescriptionFallback: 'No description provided.',
    ...
    criticalPermissionBadge: 'CRITICAL',
    highImpactPermissionTitle: 'High impact',
    sensitivePermissionTooltip: 'This permission can overwrite existing users, roles and all permissions.',
    systemRole: 'System',
    ...
    cvss4: {
        ...
        // Source: NVD CVSS v4 calculator tooltips
        tooltip: {
            baseMetricGroup_Legend: "The Base Metric group represents the intrinsic  characteristics of a vulnerability that are constant over time and across user environments. Determine the vulnerable component and score Attack Vector, Attack Complexity, Attack Requirements, Privileges Required and User Interaction relative to this.",
    ...
    disableUsersWarning: 'Disabled users will not be able to sign in or access the system. You can re-enable them at any time.',
    auditNum1: 'Audit',
    auditNums: 'Audits',
    ...
    languageToolRules: 'LanguageTool Rules',
    viewRule: 'View Rule',
    ...
    languageToolApiKey: 'API Key (optional)',
    languageToolApiKeyHint: 'Required for LanguageTool Premium or self-hosted pwndoc-languagetools with authentication enabled',
    languageToolUsername: 'Username (optional)',
    languageToolUsernameHint: 'Required only for LanguageTool Premium API',
    testConnection: 'Test Connection',
    reachable: 'Reachable',
    notReachable: 'Not Reachable',
    validLanguageTool: 'Valid LanguageTool',
    notLanguageTool: 'Not a LanguageTool endpoint',
    authValid: 'Credentials Valid',
    authInvalid: 'Credentials Invalid',
    apiKeyRequired: 'API Key Required',
    customRulesSupported: 'Custom Rules Supported',
    customRulesNotSupported: 'Custom Rules Not Supported',
    ...
    neededForUsers: 'Needed for Users',
    ...
    draftRecovery: {
        ...
        message: 'Review the differences between your recovered changes and the last saved version.',
        savedAt: 'Saved locally on',
        currentVersion: 'Last saved version',
        draftVersion: 'Your recovered changes',
        ...
        localDraftExists: 'Recovered changes exist',
        viewingLocalDraft: 'You are viewing your recovered changes',
        notSavedToServer: 'Save to persist your changes',
        viewingServerVersion: 'You are viewing the last saved version',
        localDraftNotApplied: 'Recovered changes exist but are not applied',
        draftExpiresIn: 'Expires in',
        draftExpired: 'Expired',
        clearedAfterInactivity: 'Recoverable until then',
        discardDraft: 'Revert to saved version',
        discardLocalChanges: 'Return to the last saved version',
        viewChangesLabel: 'View changes',
        reviewChangesInDraft: 'Review changes in this draft',
        restoreDraftLabel: 'Restore recovered changes',
        replaceWithDraft: 'Replace current content with recovered changes',
        deletePermanently: 'Delete recovered changes permanently',
        actionCannotBeUndone: 'This action cannot be undone',
        compareWithDraft: 'Compare server version with recovered changes',
        saveHint: 'Use Save (ctrl+s) in the toolbar to save your changes.',
        edited: 'Edited',
